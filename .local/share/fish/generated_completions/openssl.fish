# openssl
# Autogenerated from man page /usr/share/openssl/man/man1/openssl.1.gz
...
complete -c openssl -o dtls -o dtls1 -o dtls1_2 -d 'These options specify to use \\s-1DTLS\\s0 instead of \\s-1TLS'
