# sudo_logsrvd
# Autogenerated from man page /usr/local/man/man8/sudo_logsrvd.8.gz
complete -c sudo_logsrvd -s f -d 'Read configuration from file instead of the default, /usr/local/etc/sudo_logs…'
