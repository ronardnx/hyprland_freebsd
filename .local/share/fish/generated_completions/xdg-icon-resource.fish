# xdg-icon-resource
# Autogenerated from man page /usr/local/man/man1/xdg-icon-resource.1.gz
...
complete -c xdg-icon-resource -s 1 -d 'Error in command line syntax'
complete -c xdg-icon-resource -s 2 -d 'One of the files passed on the command line did not exist'
complete -c xdg-icon-resource -s 3 -d 'A required tool could not be found'
complete -c xdg-icon-resource -s 4 -d 'The action failed'
complete -c xdg-icon-resource -s 5 -d 'No permission to read one of the files passed on the command line'
